...
function fetchCollectionDataFromDF () {
  ...
  return fetch(`https://api.dialogflow.com/v1/entities/f505c2f0-8ffc-4196-a87d-1d6cab3e4b80?v=20150910`, { method: `GET`, headers: { 'Content-Type': 'application/json;charset=UTF-8', 'authorization': 'BEARER a55db7f7ed0a4b52a0982b22e2428f18'}})
    .then(res => res.json())
    .then(data => {
...
function deleteCollectionDataFromDF (creators) {
  ...
  return fetch(`https://api.dialogflow.com/v1/entities/f505c2f0-8ffc-4196-a87d-1d6cab3e4b80?v=20150910`, { method: `DELETE`, body: JSON.stringify(creators), headers: { 'Content-Type': 'application/json;charset=UTF-8', 'authorization': 'BEARER a55db7f7ed0a4b52a0982b22e2428f18'}})
    .then(res => res.json())
    .then(data => {
      debug(util.inspect(data, false, null));
      debug(`posted Collection to dialogflow Successfully.`);
